...
1. Creo un ciclo for che parte da 1 e finisce a 100;
2. Per i numeri divisibili per 3 stampo "Fizz"
3. Per quelli divisibili per 5 stampo "Buzz".
4. Per quelli divisibili per entrambi stampo "FizzBuzz"
